...
Отвечает за рекурсивный обход директорий, глубокую классификацию медиафайлов,
вычисление контрольных сумм (для поиска дубликатов) и фильтрацию системного мусора.

Автор: Белкина Анна Сергеевна (или твоё ФИО, если ты Никита, подставь своё!)
