...
Описание:
    ...
    извлечение именованных сущностей из имён медиафайлов.
    Обучение проводится на синтетическом датасете
    data/raw/synthetic_media_names.csv. Результат сохраняется
    в ml/weights/model.pt.
=============================================================================
"""
